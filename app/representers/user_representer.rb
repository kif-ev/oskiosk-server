class UserRepresenter < ApplicationDecorator
  ...
  property :name
  property :balance, writeable: false, type: Representable::Coercion::Types::Params::Integer
  property :allow_negative_balance, type: Representable::Coercion::Types::Params::Bool
  collection(
    :tags,
